...
\def\thesisauthor{Mindaugas Laganeckas} % Thesis author
\def\thesistitle{A Simulator for high level Petri Nets: Model based design and implementation} % Title of thesis
\def\thesiskeywords{simulator high level Petri Nets model based software engineering}
...
\bibliography{myrefs}    % Bibliography
